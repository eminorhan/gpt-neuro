...
#SBATCH --job-name=evaluate_lang_primate_8B_131k
#SBATCH --output=evaluate_lang_primate_8B_131k_%A_%a.out
#SBATCH --array=0
#SBATCH --qos=debug
...
CONFIG_FILE=${CONFIG_FILE:-"./eval_configs/lang_primate_8b_131k.toml"}
