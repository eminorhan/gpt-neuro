...
export TRITON_CACHE_DIR="/lustre/orion/stf218/scratch/emin/triton"
export PYTORCH_KERNEL_CACHE_PATH="/lustre/orion/stf218/scratch/emin/pytorch_kernel_cache"
...
CONFIG_FILE=${CONFIG_FILE:-"./train_configs/rodent_8b_131k_short.toml"}
