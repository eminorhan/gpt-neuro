...
srun torchrun --nnodes $SLURM_NNODES --nproc_per_node 8 --node_rank $SLURM_NODEID --rdzv_id 101 --rdzv_backend c10d --rdzv_endpoint "$MASTER_ADDR:$MASTER_PORT" ./generate.py --config ${CONFIG_FILE} --ckpt "outputs/rodent_8B_131k/checkpoint/step-7560" --ds_name "eminorhan/neural-bench-rodent" --ds_split "train"
